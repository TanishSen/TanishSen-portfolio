...
export function MusicMarquee({
  ...
  // Design & Coding-related phrases for the marquee
  const musicPhrases = [
    'CLEAN CODE, MESSY DESK',
    'PUSHING PIXELS & COMMITS',
    'FONTS, FUNCTIONS, AND FIRE VIBES',
    'FLEXBOXING MY WAY THROUGH LIFE',
    'GRID LINES & GOOD TIMES',
    'FRONTEND SYMPHONIES',
    'FRONTEND WITH FLARE',
    'WIREFRAMES TO WOW',
    'DEPLOYING VIBES DAILY',
    'BUILDING BEAUTY WITH JS & CSS',
    'THE ART OF PIXEL ENGINEERING',
