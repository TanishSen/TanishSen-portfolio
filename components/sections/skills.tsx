    ...
    <section id="skills" className="py-16" ref={ref}>
      ...
      >
        ...
        <motion.p
          ...
          variants={itemVariants}
        >
          Just as a designer learns new tools to bring ideas to life, I’ve built
          expertise in various technologies to deliver smooth, high-impact
          digital solutions.
        </motion.p>
              ...
              {Array(2)
                ...
                .map((_, i) => (
                  <div key={i} className="inline-flex items-center gap-8">
                    ...
                    <span className="text-primary-light flex items-center gap-2 text-xl">
                      <Play className="h-4 w-4" /> Java
                    </span>
                    <span className="text-primary-light flex items-center gap-2 text-xl">
                      <Play className="h-4 w-4" /> C
                    </span>
                    <span className="text-primary-light flex items-center gap-2 text-xl">
