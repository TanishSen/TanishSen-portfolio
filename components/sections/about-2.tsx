          ...
          <div className="group relative overflow-hidden rounded-3xl bg-zinc-100 dark:bg-zinc-800/50">
            ...
            <div className="relative z-10 p-8">
              ...
              <p className="text-lg leading-relaxed text-zinc-700 dark:text-zinc-300">
                I see every digital product as a canvas—an opportunity to blend
                logic and creativity into something meaningful. Whether I’m
                building responsive web apps with React and Next.js or crafting
                seamless mobile experiences with React Native, I aim to deliver
                interfaces that are not only functional but truly engaging. With
                a strong eye for UI/UX design and a deep curiosity for emerging
                tech, I create experiences that feel intuitive, look stunning,
                and leave a lasting impact—like a well-composed symphony of code
                and creativity.
              </p>
            </div>
