...
const FlipLink = ({ children, href, icon }: FlipLinkProps) => {
  ...
  return (
    <motion.a
      ...
      target="_blank"
      href={href}
      className="group relative block overflow-hidden text-3xl font-black whitespace-nowrap uppercase sm:text-5xl md:text-6xl lg:text-7xl"
      style={{
        lineHeight: 0.85,
      }}
    >
...
export function ContactSection() {
  ...
  const email = "tanishsen.2520@gmail.com";
  // const mailtoUrl = `mailto:${email}`;
  const mailtoUrl = `mailto:${email}?subject=Hello&body=Hi Tanish, looking forward to connecting with you!`;
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-6 md:gap-8">
            ...
            <FlipLink
              href="https://linkedin.com/in/tanishsen"
