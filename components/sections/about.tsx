            ...
            <div className="group relative flex h-full min-h-[500px] overflow-hidden rounded-3xl">
              ...
              >
                ...
                <div className="space-y-4 text-zinc-700 dark:text-zinc-300">
                  <p>
                    I'm Tanish Sen, a passionate frontend developer and UI/UX
                    designer with a strong foundation in HTML, CSS, JavaScript,
                    and React. I specialize in building responsive,
                    high-performance web and hybrid applications using React,
                    Next.js, and React Native.
                  </p>
                  <p>
                    My approach to development blends technical expertise with a
                    strong sense of design. With experience in UI/UX design, I
                    focus on creating intuitive interfaces that not only
                    function smoothly but also deliver visually compelling user
                    experiences. Whether it's prototyping in Figma or polishing
                    interfaces with modern aesthetics, I love bringing ideas to
                    life with creativity and precision.
                  </p>
                  <p>
                    From building AI-powered tools and secure communication apps
                    to image generators and interactive platforms, I enjoy
                    solving real-world problems through innovative digital
                    solutions. I'm always exploring new technologies, refining
                    my DSA skills, and contributing to open source initiatives.
                  </p>
                  <p>
                    Outside of tech, I draw inspiration from music,
                    thought-provoking films, and design communities. Whether I’m
                    sketching out a new UI concept or jamming to music that
                    sparks creativity, I'm constantly exploring ways to blend
                    technology and art.
                  </p>
                </div>
        ...
        >
          ...
          <div className="group relative overflow-hidden rounded-3xl">
            ...
            <div className="relative z-5 flex flex-col items-center p-8">
              ...
              <p className="text-center text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                ...
                grow with the ever-evolving web.
              </p>
          ...
          <div className="group relative overflow-hidden rounded-3xl">
            ...
            <div className="relative z-5 flex flex-col items-center p-8">
              ...
              <p className="text-center text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                Focusing on the smallest details to design clean, smooth, and
              ...
              <div className="p-12 backdrop-blur-[2px]">
                ...
                <div className="relative">
                  ...
                  <p className="px-3 text-lg leading-relaxed text-zinc-700 md:text-xl md:leading-relaxed dark:text-zinc-300">
                    I believe impactful digital products are like immersive
                    symphonies — they blend{" "}
                    <span className="text-primary font-medium">structure</span>,{" "}
                    ...
                    . Every line of code is an instrument, and every interaction
                    a note. Whether I’m building web apps with React and Next.js
                    or crafting seamless mobile experiences with React Native,
                    my goal is to create intuitive, high-performance interfaces
                    that not only work beautifully but resonate deeply. With a
                    strong foundation in UI/UX design and a passion for
                    innovation, I design digital experiences that users love
                    coming back to.
                  </p>
                </div>
              </div>
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-2 rounded-full border border-zinc-200/80 bg-white/80 px-5 py-3 text-zinc-800 backdrop-blur-sm transition-all duration-300 group-hover:border-transparent group-hover:text-white dark:border-zinc-700/80 dark:bg-zinc-800/80 dark:text-zinc-200">
              ...
              <Palette className="h-4 w-4 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12" />

              <span className="text-sm font-medium">Crafting clean </span>
            </div>
